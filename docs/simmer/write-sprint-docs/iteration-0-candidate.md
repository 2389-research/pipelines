...
- Number the steps (1. do X, 2. do Y, ...)
- Provide verbatim code for critical snippets (SQL queries, concurrency patterns, CLI dispatch)
...
Before writing sprint N, read all previously written .ai/sprints/SPRINT-*.md files.
...
Write ALL sprint files in one pass to ensure cross-sprint consistency.
